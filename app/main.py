...
def admin_panel(request: Request, db: Session = Depends(get_db), user_id: int = None):
    # For demo, get user by user_id query param (in real app, use auth)
    ...
    return admin_templates.TemplateResponse("admin_panel.html", {"request": request, "user": user, "users": users, "chatbots": chatbots, "tenants": tenants})
...
def signup_page(request: Request):
    return admin_templates.TemplateResponse("signup.html", {"request": request})
